...
async function createStudentAccount() {
  try {
    ...
    // Get user input
    const email = await promptUser("Enter student email: ");
    ...
    const finalUsername = username || "student_" + Math.floor(Math.random() * 10000);
    ...
    const finalPassword = password || "Student" + Math.floor(Math.random() * 10000);
